...
class _DashboardState extends State<Dashboard> {
  ...
  // void getAppointmentData(picked) async {
  //   var url = Uri.parse('https://docdock.onrender.com/');
  ...
  //     Appointment.appList = responseList.cast<Appointment>();
  //     // print(responseList);
  //   });
  // }
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Align(
                              alignment: Alignment.centerLeft,
                              child: Text('Here\'s a list of appointments for the day',
                                  style: TextStyle(
                                    color: Colors.white38,
                                    fontSize: 16,
                                  )))
                ...
                Positioned(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          DateFormat('d\'${_getDaySuffix(today.day)}\' MMMM, yyyy')
                              .format(today),
